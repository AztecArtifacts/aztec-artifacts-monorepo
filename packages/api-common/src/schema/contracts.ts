...
export const contractInstances = pgTable('contract_instances', {
  ...
  currentContractClassId: frField().references(() => contractArtifacts.contractClassId),
  originalContractClassId: frField().references(() => contractArtifacts.contractClassId),
