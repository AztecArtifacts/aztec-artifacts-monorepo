...
import { aztecAddressToHexString, hexStringToAztecAddress, type tokens } from '@aztec-artifacts/api-common';
import { describe, expect, it, vi } from 'vitest';
import { convertDbTokenToApi } from '../services/token-service.js';
import { normalizeAddress } from '../utils/response.js';

vi.mock('@aztec-artifacts/api-common', async () => {
  const actual = await vi.importActual<typeof import('@aztec-artifacts/api-common')>('@aztec-artifacts/api-common');
  return {
    ...actual,
