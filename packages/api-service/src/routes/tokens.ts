...
import { createHttpMetricTags, recordErrorMetrics, recordHttpMetrics } from '../utils/metrics.js';
  ...
  fastify.get<{
    ...
    async (request, reply) => {
      ...
      try {
        ...
        addSpanAttributes(createHttpSpanAttributes('GET', '/tokens', statusCode));
        recordHttpMetrics(createHttpMetricTags('GET', '/tokens', statusCode), responseTime);
        ...
        addSpanAttributes(createHttpSpanAttributes('GET', '/tokens', statusCode));
        recordHttpMetrics(createHttpMetricTags('GET', '/tokens', statusCode), responseTime);
        recordErrorMetrics('route_handler_error');
    ...
    async (request, reply) => {
      ...
      try {
        ...
        if (!dbToken) {
          ...
          addSpanAttributes(createHttpSpanAttributes('GET', '/tokens/:address', statusCode));
          recordHttpMetrics(createHttpMetricTags('GET', '/tokens/:address', statusCode), responseTime);
